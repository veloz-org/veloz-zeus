...
function Hero() {
  return (
    <FlexColCenter className="w-full h-full min-h-[600px] text-center border-b-solid border-b-[1px] border-b-white-300 dark:border-b-white-600 ">
      ...
      <h1 className="text-3xl md:text-5xl transition-all font-ppEB text-dark-100 dark:text-white-100">
      ...
      <p className="w-full md:max-w-[95%] max-w-[90%] text-white-400 dark:text-white-300 text-sm md:text-md transition-all font-ppReg">
